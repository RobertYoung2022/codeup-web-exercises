...
/*
function analyzeColor(trueColor) {
        if (trueColor == "blue") {
            console.log("The color is blue");
        } else if (trueColor == "red") {
            console.log("The color is red");
        } else if (trueColor == "yellow") {
            console.log("The color is yellow");
        } else if (trueColor == "green") {
        console.log("The color is green");
        } else if (trueColor == "violet") {
            console.log("The color is violet");
        } else if (trueColor == "orange") {
            console.log("The color is orange");
        } else if (trueColor == "indigo") {
            console.log("The color is indigo");
        } else {
        console.log("Any other color");
        }
}
analyzeColor("blue");
*/
...
/*let pageColorPicker = prompt("What color would you like?")
switch (pageColorPicker) {
    case "red":
        alert("Red");
        break;
    case "orange":
